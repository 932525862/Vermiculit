  ...
  <div className="container mx-auto px-4">
    ...
    <div className="max-w-6xl mx-auto overflow-x-auto">
          ...
          <div className="overflow-x-auto">
            <table className="w-full">
              <thead className="bg-primary text-primary-foreground">
                <tr>
                  <th className="px-6 py-4 text-left font-bold">{t("about.export.table.number")}</th>
                  <th className="px-6 py-4 text-left font-bold">{t("about.export.table.country")}</th>
                  <th className="px-6 py-4 text-left font-bold">{t("about.export.table.demand")}</th>
                  <th className="px-6 py-4 text-left font-bold">{t("about.export.table.exported")}</th>
                  <th className="px-6 py-4 text-left font-bold">{t("about.export.table.unmet")}</th>
                </tr>
              </thead>
              ...
              <tbody>
                {[
                  ...
                  <tr key={index} className="border-b hover:bg-muted/50 transition-colors">
                    ...
                    <td className="px-6 py-4 font-semibold">{t(`about.export.countries.${row[0]}`)}</td>
                    <td className="px-6 py-4">{row[1]}</td>
                    <td className="px-6 py-4 text-primary font-semibold">{row[2]}</td>
                ...
                <tr className="bg-primary/10 font-bold">
                  ...
                  <td className="px-6 py-4">{t("about.export.table.total")}</td>
      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-serif font-bold mb-4">{t("about.whatWeDo.heading")}</h2>
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="text-center hover:shadow-gold transition-shadow">
              <CardContent className="pt-8">
                ...
                <h3 className="text-xl font-bold mb-3">{t("about.whatWeDo.mining.title")}</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="text-center hover:shadow-gold transition-shadow">
              <CardContent className="pt-8">
                ...
                <h3 className="text-xl font-bold mb-3">{t("about.whatWeDo.processing.title")}</h3>
                <p className="text-muted-foreground">
            ...
            <Card className="text-center hover:shadow-gold transition-shadow">
              <CardContent className="pt-8">
                ...
                <h3 className="text-xl font-bold mb-3">{t("about.whatWeDo.distribution.title")}</h3>
                <p className="text-muted-foreground">
